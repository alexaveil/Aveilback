...
from transformers_pytorch.dutils import get_dataset, make_logdir
...
def train():
    ...
    parser.add_argument("--dataset_path", type=str, default="TEST_DATASET/persona_example.json", help="Path or url of the dataset. If empty download from S3.")
